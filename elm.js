...
var $author$project$Main$init = function (_v0) {
	return _Utils_Tuple2(
		{l: 4, J: 120, K: '120', D: 8, m: true, y: 500, z: 2000},
...
var $author$project$Main$fontSizeNumerator = 32;
	...
	function (msg, model) {
		switch (msg.$) {
			case 0:
				...
				var newMsPerMeasure = A2($author$project$Main$calculateMsPerMeasure, model.l, newOffset);
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{J: newBpm, K: bpm, m: !model.m, y: newOffset, z: newMsPerMeasure}),
					$elm$core$Platform$Cmd$none);
			case 1:
				var newBeatsPerMeasure = A2($elm$core$Basics$min, 16, model.l + 1);
				var newFontSize = A3($elm$core$Basics$clamp, 2, 8, ($author$project$Main$fontSizeNumerator / newBeatsPerMeasure) | 0);
				var newMsPerMeasure = A2($author$project$Main$calculateMsPerMeasure, newBeatsPerMeasure, model.y);
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{l: newBeatsPerMeasure, D: newFontSize, m: !model.m, z: newMsPerMeasure}),
					$elm$core$Platform$Cmd$none);
			default:
				var newBeatsPerMeasure = A2($elm$core$Basics$max, 1, model.l - 1);
				var newFontSize = A3($elm$core$Basics$clamp, 2, 8, ($author$project$Main$fontSizeNumerator / newBeatsPerMeasure) | 0);
				var newMsPerMeasure = A2($author$project$Main$calculateMsPerMeasure, newBeatsPerMeasure, model.y);
				return _Utils_Tuple2(
					_Utils_update(
...
var $author$project$Main$DecrementBPMeasure = {$: 2};
var $author$project$Main$IncrementBPMeasure = {$: 1};
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					'animation-name',
					model.m ? 'frames' : 'frames-alternate'),
					A2(
					$elm$html$Html$Attributes$style,
					'animation-duration',
					$elm$core$String$fromFloat(model.z) + 'ms'),
					A2(
					$elm$html$Html$Attributes$style,
					'animation-delay',
					$elm$core$String$fromFloat(idx * model.y) + 'ms')
				]),
			_List_fromArray(
				[
					A2(
					...
					_List_fromArray(
						[
							...
							$elm$html$Html$Attributes$style,
							'font-size',
							$elm$core$String$fromInt(model.D) + 'em')
						]),
					_List_fromArray(
						[
							$elm$html$Html$text(
				...
				_List_fromArray(
					[
						...
						A2(
							...
							A2($elm$core$List$repeat, model.l, model))),
						A2(
						$elm$html$Html$div,
						_List_fromArray(
							[
